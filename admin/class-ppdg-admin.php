...
class PPDG_Admin {
	...
	public function register_settings($value='')
	{
        ...
        public function general_documentation_callback($args)
        {
            ...
            <p>Please read the
            <a target="_blank" href="http://www.tipsandtricks-hq.com/paypal-for-digital-goods-wordpress-plugin">PayPal for Digital Goods</a> plugin setup instructions to configure and use it.
            </p>
            </div>
            <?php
        }
