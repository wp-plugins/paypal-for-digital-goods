        ...
        switch ($step) {
            case 'checkout':
                ...
                if (empty($_POST['currency_code'])) {
                    die('Please specify currency code either in the shortcode or in General > PPDG section in admin panel.');
                }
                ...
                //'------------------------------------
                $currencyCodeType = strtoupper($_POST['currency_code']);
                $paymentType = "Sale";
                ...
                $items = array();
                $items[] = array('name' => $_POST['item_name'], 'amt' => $_POST['item_price'], 'qty' => $_POST['item_quantity']);
                ...
                if ($ack == "SUCCESS" || $ack == "SUCCESSWITHWARNING") {
                    ...
                    $pfdg_txn_data = array('token' => $token, 'item_url' => $_POST['item_url']);
            ...
            case 'cancel':
                ...
                break;
            case 'confirm':
                $res = $this->paypaldg->GetExpressCheckoutDetails($_REQUEST['token']);
                ...
                if ($ack == "SUCCESS" || $ack == "SUCCESSWITHWARNING") {
                    ...
                    if (isset($_SESSION['pfdg_resarray'])) {
                        ...
                        if ($saved_token == $token) {
                            $item_url = base64_decode($pfdg_txn_data['item_url']);
                        }
                    }
                    /*
